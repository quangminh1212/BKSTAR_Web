  ...
  (function (n, s) {
    ...
    function l(t, e) {
      ...
      o
        ...
        : r && r.error('Bad element for ' + this.constructor.namespace + ': ' + (o || t));
    }
      ...
      (d.resizeContainer = function () {
        ...
        !this._getOption('resizeContainer') ||
          ((t = this._getContainerSize()) &&
            (this._setContainerMeasure(t.width, !0), this._setContainerMeasure(t.height, !1)));
      }),
      ...
      (l._filter = function (t) {
        for (
          ...
          var a,
            u = t[r];
          u.isIgnored ||
            ((a = s(u)) && i.push(u), a && u.isHidden ? o.push(u) : a || u.isHidden || n.push(u));
        }
    ...
    ((h.sortDataParsers = {
      ...
      (l.appended = function (t) {
        var e,
          i = this.addItems(t);
        i.length &&
          ((e = this._filterRevealAdded(i)), (this.filteredItems = this.filteredItems.concat(e)));
      }),
        ...
        e(document).on('click', '.eael-load-more-button', function (a) {
          ...
          if ((t.attr('disabled', !0), void 0 !== r && void 0 !== c)) {
            ...
            if ('Essential_Addons_Elementor\\Elements\\Woo_Product_Gallery' == b.class) {
              var h = {
                taxonomy: e('.eael-cat-tab li a.active', s).data('taxonomy'),
                field: 'term_id',
                terms: e('.eael-cat-tab li a.active', s).data('id'),
                terms_tag: e('.eael-cat-tab li a.active', s).data('tagid'),
              };
              if ('true' == localStorage.getItem('eael-cat-tab')) {
                localStorage.removeItem('eael-cat-tab');
                var w = 2;
              } else {
                var E = e('.eael-cat-tab li a.active', s),
                  x = parseInt(E.data('page'));
                if (isNaN(x))
                  if (E.length > 0) ((x = 1), E.data('page', 1));
                  else {
                    var C = e('.eael-load-more-button', s);
                    x = parseInt(C.data('page'));
                    isNaN(x) && (x = 1);
                  }
                w = x + 1;
              }
              ((b.taxonomy = h), (b.page = isNaN(w) ? m : w));
            }
            if (
              ('Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery' ===
                b.class &&
                (e('.dynamic-gallery-item-inner', s).each(function () {
                  f.push(e(this).data('itemid'));
                }),
                (y = e('.elementor-element-' + r + ' .dynamic-gallery-category.active').data(
                  'termid'
                )),
                (_ = e('.elementor-element-' + r + ' .dynamic-gallery-category.active').data(
                  'taxonomy'
                )),
                (b.page = 1),
            ...
            e.ajax({
              ...
              success: function (a) {
                ...
                if ((t.removeAttr('disabled'), r.hasClass('no-posts-found') || 0 === r.length))
                  'Essential_Addons_Elementor\\Elements\\Woo_Product_Gallery' == b.class
                    ? (t.removeClass('button--loading').addClass('hide-load-more'),
                      o.html(l),
                      t.parent().hasClass('eael-infinity-scroll') && t.parent().remove())
                    : 'Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery' ==
                        b.class
                      ? (t.removeClass('button--loading'), o.html(l), S(t))
                      : t.remove();
                else {
                  if ('Essential_Addons_Elementor\\Elements\\Product_Grid' == b.class) {
                    if (
                      ((r = r.filter('li')),
                      e('.eael-product-grid .products', s).append(r),
                      'masonry' == p)
                    ) {
                      var n = 'eael-product-' + Date.now();
                      ((d = e('.eael-product-grid .products', s).isotope())
                        .isotope('appended', r)
                        .isotope('layout'),
                        d.imagesLoaded().progress(function () {
                          d.isotope('layout');
                        }),
                        r.find('.woocommerce-product-gallery').addClass(n),
                        r.find('.woocommerce-product-gallery').addClass('eael-new-product'),
                        e('.woocommerce-product-gallery.' + n, s).each(function () {
                          e(this).wc_product_gallery();
                        }));
                    } else {
                      var i = 'eael-product-' + Date.now();
                      (r.find('.woocommerce-product-gallery').addClass(i),
                        r.find('.woocommerce-product-gallery').addClass('eael-new-product'),
                        e('.woocommerce-product-gallery.' + i, s).each(function () {
                          e(this).wc_product_gallery();
                        }));
                    }
                    m >= g && t.remove();
                    ...
                    var d;
                    if ((e('.eael-post-appender', s).append(r), 'masonry' == p))
                      ((d = e('.eael-post-appender', s).isotope())
                        .isotope('appended', r)
                        .isotope('layout'),
                        d.imagesLoaded().progress(function () {
                          d.isotope('layout');
                  ...
                  if (
                    ...
                    o.html(l),
                    'Essential_Addons_Elementor\\Elements\\Woo_Product_Gallery' == b.class &&
                    e('.eael-cat-tab li a.active', s).length
                      ? e('.eael-cat-tab li a.active', s).data('page', w)
                      : t.data('page', m),
                    'Essential_Addons_Elementor\\Pro\\Elements\\Dynamic_Filterable_Gallery' ==
                      b.class)
                  ) {
                    var c = e(r[0]);
                    c.hasClass('found_posts') && c.text() - v.posts_per_page < 1 && S(t);
        ...
        e(window).on('scroll', function () {
          ...
          e.each(a, function (a, t) {
            var o = e(t),
              ...
              s = i + e(window).height() - l;
            n > i && r < s && e('.eael-load-more-button', o).trigger('click');
          });
        }));
    })(jQuery);
  },
