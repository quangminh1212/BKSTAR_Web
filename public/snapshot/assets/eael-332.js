    ...
    eael.hooks.addAction('init', 'ea', function () {
      elementorFrontend.hooks.addAction(
        ...
        function (e, t) {
          ...
          ((a || 'yes' === d) &&
            i.each(function () {
              ('yes' === d && t(this).attr('data-scroll', t(this).offset().top),
                a &&
                  t(this).attr('id') == a &&
                  ((o = !0), t(this).addClass('show-this active'), t(this).next().slideDown(r)));
            }),
            !1 === o &&
              i.each(function () {
                t(this).hasClass('active-default') &&
                  (t(this).addClass('show-this active'), t(this).next().slideDown(r));
              }),
            i.unbind('click'),
            i.click(function (e) {
              e.preventDefault();
              ...
              if (
                ...
                if (
                  ('accordion' === s
                    ? a.hasClass('show-this')
                      ? (a.removeClass('show-this active'), a.next().slideUp(r))
                      : (a
                          .parent()
                          .parent()
                          .find('.eael-accordion-header')
                          .removeClass('show-this active'),
                        a.parent().parent().find('.eael-accordion-content').slideUp(r),
                        a.toggleClass('show-this active'),
                        a.next().slideToggle(r))
                    : a.hasClass('show-this')
                      ? (a.removeClass('show-this active'), a.next().slideUp(r))
                      : (a.addClass('show-this active'), a.next().slideDown(r)),
                  'yes' === d && a.hasClass('active'))
                ) {
                  var o = c ? parseFloat(c) : 0;
                  t('html, body').animate({ scrollTop: t(this).data('scroll') - o }, l);
                }
                setTimeout(function () {
                  (a.addClass('triggered'),
                    eael.hooks.doAction('widgets.reinit', a.parent()),
                    eael.hooks.doAction('ea-advanced-accordion-triggered', a.next()));
                }, 50);
              }
            }),
