  ...
  function l(e) {
    ...
    d &&
      ...
      d &&
        ...
        t &&
        (n && 'A' === n.nodeName && n.id !== b.cancelReplyId && (n.style.display = ''),
        (d.textContent = t)),
      e.preventDefault());
  }
  function a(e) {
        ...
        if (e && h && n) {
          (void 0 === o && (o = p && p.textContent),
            ...
            p &&
              ...
              (u && 'A' === u.nodeName && u.id !== b.cancelReplyId && (u.style.display = 'none'),
              (p.textContent = o)),
            (I.onclick = function () {
              return !1;
            }));
          try {
            for (var f = 0; f < C.elements.length; f++)
              if (
                ...
                ((i.offsetWidth <= 0 && i.offsetHeight <= 0) || 'hidden' === l.visibility) &&
                  (r = !0),
